...
public class CoefficientMatrix {
	public static Map<String,Double> findSDAGCoefficient(List<String> formulates) {
    	...
    	List<String> list = extractSDAGVariables(variables);
    ...
    public static List<String> extractVariables(List<String> functionCalls) {
        ...
        for (String call : functionCalls) {
            ...
            variables.add(args[0].trim() + "," + args[1].trim()+","+args[2].trim());
         
        }
        return variables;
    }
    public static List<String> extractSDAGVariables(List<String> functionCalls) {
        List<String> variables = new ArrayList<>();
